...
painthistoverlap(max_fc1_weight_sum,mid_fc1_weight_sum,min_fc1_weight_sum,"All weights comparisons of layer 1",1)
painthistoverlap(max_fc2_weight_sum,mid_fc2_weight_sum,min_fc2_weight_sum,"All weights comparisons of layer 2",2)
painthistoverlap(max_fc3_weight_sum,mid_fc3_weight_sum,min_fc3_weight_sum,"All weights comparisons of layer 3",3)
plt.tight_layout()
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result/whole_weight_distribution_overlap.png")
plt.show()